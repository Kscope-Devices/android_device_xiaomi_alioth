...
BOARD_PREBUILT_ODMIMAGE := $(ALIOTH_PREBUILT)/odm.img
BOARD_PREBUILT_VENDORIMAGE := $(ALIOTH_PREBUILT)/vendor.img

BOARD_ALIOTH_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor
